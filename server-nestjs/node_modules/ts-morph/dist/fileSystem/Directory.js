...
var Directory = /** @class */ (function () {
    ...
    Object.defineProperty(Directory.prototype, "_context", {
        /** @internal */
        get: function () {
     ...
     * @internal
     */
    Directory.prototype._getDepth = function () {
    ...
    Directory.prototype.getDirectoryOrThrow = function (pathOrCondition) {
        ...
        return errors.throwIfNullOrUndefined(this.getDirectory(pathOrCondition), function () {
            if (typeof pathOrCondition === "string")
                return "Could not find a directory at path '" + _this._context.fileSystemWrapper.getStandardizedAbsolutePath(pathOrCondition, _this.getPath()) + "'.";
            return "Could not find child directory that matched condition.";
        });
    };
    Directory.prototype.getDirectory = function (pathOrCondition) {
        if (typeof pathOrCondition === "string") {
            var path = this._context.fileSystemWrapper.getStandardizedAbsolutePath(pathOrCondition, this.getPath());
    ...
    Directory.prototype.getSourceFileOrThrow = function (pathOrCondition) {
        ...
        return errors.throwIfNullOrUndefined(this.getSourceFile(pathOrCondition), function () {
            if (typeof pathOrCondition === "string")
                return "Could not find child source file at path '" + _this._context.fileSystemWrapper.getStandardizedAbsolutePath(pathOrCondition, _this.getPath()) + "'.";
    ...
    Directory.prototype.getDescendantSourceFiles = function () {
        return utils_1.ArrayUtils.from(this._getDescendantSourceFilesIterator());
    };
    /**
     * Gets the source files in the current directory and all the descendant directories.
     * @internal
     */
    Directory.prototype._getDescendantSourceFilesIterator = function () {
        ...
        return tslib_1.__generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 8:
                    ...
                    directory = _f.value;
                    return [5 /*yield**/, tslib_1.__values(directory._getDescendantSourceFilesIterator())];
                case 9:
                    _g.sent();
                    _g.label = 10;
                case 10:
    ...
    Directory.prototype.getDescendantDirectories = function () {
        return utils_1.ArrayUtils.from(this._getDescendantDirectoriesIterator());
    };
    /**
     * Gets the descendant directories.
     * @internal
     */
    Directory.prototype._getDescendantDirectoriesIterator = function () {
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _d.sent();
                    return [5 /*yield**/, tslib_1.__values(directory._getDescendantDirectoriesIterator())];
                case 3:
                    _d.sent();
                    _d.label = 4;
                case 4:
    ...
    Directory.prototype.addExistingDirectoryIfExists = function (dirPath, options) {
        ...
        return this._context.directoryCoordinator.addExistingDirectoryIfExists(dirPath, tslib_1.__assign({}, options, { markInProject: this._isInProject() }));
    };
    /**
    ...
    Directory.prototype.addExistingDirectory = function (dirPath, options) {
        if (options === void 0) { options = {}; }
        dirPath = this._context.fileSystemWrapper.getStandardizedAbsolutePath(dirPath, this.getPath());
        return this._context.directoryCoordinator.addExistingDirectory(dirPath, tslib_1.__assign({}, options, { markInProject: this._isInProject() }));
    };
    /**
     ...
     */
    Directory.prototype.createSourceFile = function (relativeFilePath, sourceFileText, options) {
        var filePath = this._context.fileSystemWrapper.getStandardizedAbsolutePath(relativeFilePath, this.getPath());
        return this._context.compilerFactory.createSourceFile(filePath, sourceFileText || "", tslib_1.__assign({}, (options || {}), { markInProject: this._isInProject() }));
    };
    /**
    ...
    Directory.prototype.emit = function (options) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        fileSystemWrapper = this._context.fileSystemWrapper;
                        writeTasks = [];
                        outputFilePaths = [];
                        _d.label = 1;
                    case 1:
    ...
    Directory.prototype._emitInternal = function (options) {
        ...
        var getStandardizedPath = function (path) { return path == null ? undefined : _this._context.fileSystemWrapper.getStandardizedAbsolutePath(path, _this.getPath()); };
        var getSubDirPath = function (path, dir) { return path == null ? undefined : utils_1.FileUtils.pathJoin(path, dir.getBaseName()); };
        var hasDeclarationDir = this._context.compilerOptions.get().declarationDir != null || options.declarationDir != null;
     ...
     */
    Directory.prototype.copyToDirectory = function (dirPathOrDirectory, options) {
    ...
    Directory.prototype.copy = function (relativeOrAbsolutePath, options) {
        ...
        var fileSystem = this._context.fileSystemWrapper;
        var newPath = this._context.fileSystemWrapper.getStandardizedAbsolutePath(relativeOrAbsolutePath, this.getPath());
    ...
    Directory.prototype.copyImmediately = function (relativeOrAbsolutePath, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fileSystem = this._context.fileSystemWrapper;
    ...
    Directory.prototype._copyInternal = function (newPath, options) {
        ...
        if (originalPath === newPath)
            return this;
        var _d = this._context, fileSystem = _d.fileSystemWrapper, compilerFactory = _d.compilerFactory;
        ...
        try {
            ...
            for (var copyingDirectories_1 = tslib_1.__values(copyingDirectories), copyingDirectories_1_1 = copyingDirectories_1.next(); !copyingDirectories_1_1.done; copyingDirectories_1_1 = copyingDirectories_1.next()) {
                var newDirPath = copyingDirectories_1_1.value.newDirPath;
     ...
     */
    Directory.prototype.moveToDirectory = function (dirPathOrDirectory, options) {
        var dirPath = typeof dirPathOrDirectory === "string" ? dirPathOrDirectory : dirPathOrDirectory.getPath();
    ...
    Directory.prototype.move = function (relativeOrAbsolutePath, options) {
        ...
        if (originalPath === newPath)
            return this;
        return this._moveInternal(newPath, options, function () { return fileSystem.queueMoveDirectory(originalPath, newPath); });
    };
    /**
    ...
    /** @internal */
    Directory.prototype._moveInternal = function (newPath, options, preAction) {
        var _this = this;
        var e_12, _a, e_13, _b, e_14, _c;
        var originalPath = this.getPath();
        if (originalPath === newPath)
            return this;
        var existingDir = this._context.compilerFactory.getDirectoryFromCacheOnlyIfInCache(newPath);
        var markInProject = existingDir != null && existingDir._isInProject();
        if (preAction)
            preAction();
        var fileSystem = this._context.fileSystemWrapper;
    ...
    Directory.prototype.save = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._context.fileSystemWrapper.saveForDirectory(this.getPath())];
                    case 1:
                        _a.sent();
    ...
    Directory.prototype.getRelativePathAsModuleSpecifierTo = function (sourceFileOrDir) {
        var moduleResolution = this._context.program.getEmitModuleResolutionKind();
    ...
    /** @internal */
    Directory.prototype._isInProject = function () {
        return this._context.inProjectCoordinator.isDirectoryInProject(this);
    };
    /** @internal */
    Directory.prototype._markAsInProject = function () {
    ...
    Directory.prototype._getReferencesForMove = function (sourceFile) {
        ...
        return {
            ...
            referencingLiterals: referencingLiterals.filter(function (l) { return !_this.isAncestorOf(l._sourceFile); })
        };
    };
    /** @internal */
    Directory._isAncestorOfDir = function (ancestor, descendant) {

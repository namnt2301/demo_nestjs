...
var FileSystemWrapper = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.ensureDirectoryExists(dir)];
                    case 1:
                        // await after the state is set
                        _b.sent();
                        _b.label = 2;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.ensureDirectoryExists(parentDir)];
                    case 1:
                        _a.sent();
    ...
    FileSystemWrapper.prototype.ensureDirectoryExists = function (dir) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.fileSystem.mkdir(dir.path)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FileSystemWrapper.prototype.ensureDirectoryExistsSync = function (dir) {
        if (dir.isRootDir())
            return;
        this.removeMkDirOperationsForDir(dir);
        this.fileSystem.mkdirSync(dir.path);
    };
    FileSystemWrapper.prototype.removeMkDirOperationsForDir = function (dir) {
...
var PathCasingMaintainer = /** @class */ (function () {
    function PathCasingMaintainer(fileSystem) {
        if (fileSystem.isCaseSensitive != null && !fileSystem.isCaseSensitive())
            this.caseInsensitiveMappings = new utils_1.KeyValueCache();
    }
    PathCasingMaintainer.prototype.getPath = function (fileOrDirPath) {
        if (this.caseInsensitiveMappings == null)
            return fileOrDirPath;
        return this.caseInsensitiveMappings.getOrCreate(fileOrDirPath.toLowerCase(), function () { return fileOrDirPath; });
    };
    return PathCasingMaintainer;
}());
